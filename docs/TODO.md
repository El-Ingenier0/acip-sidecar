...
- [ ] **Oracle leakage control**: return a minimal/public threat summary plus separate audit/internal threat detail; gate internal detail behind `ACIP_AUDIT_MODE=ENABLED`.
